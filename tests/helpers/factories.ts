...
/**
 * Create a mock Accreditation Project
 */
export interface MockAccreditationProject {
  id: string;
  name: string;
  code: string | null;
  bumpInStart: Date;
...
export const createMockAccreditationProject = (
  overrides: Partial<MockAccreditationProject> = {}
): MockAccreditationProject => {
  const baseDate = new Date();
  return {
    id: generateId('project'),
    name: 'Test Event 2025',
    code: `EVT-${Date.now()}`,
    bumpInStart: new Date(baseDate.getTime() + 1 * 24 * 60 * 60 * 1000), // +1 day
    bumpInEnd: new Date(baseDate.getTime() + 3 * 24 * 60 * 60 * 1000), // +3 days
    liveStart: new Date(baseDate.getTime() + 4 * 24 * 60 * 60 * 1000), // +4 days
    liveEnd: new Date(baseDate.getTime() + 7 * 24 * 60 * 60 * 1000), // +7 days
    bumpOutStart: new Date(baseDate.getTime() + 8 * 24 * 60 * 60 * 1000), // +8 days
    bumpOutEnd: new Date(baseDate.getTime() + 10 * 24 * 60 * 60 * 1000), // +10 days
...
/**
 * Create a mock Accreditation
 */
export interface MockAccreditation {
  id: string;
...
export const createMockAccreditation = (
  overrides: Partial<MockAccreditation> = {}
): MockAccreditation => {
  const baseDate = new Date();
  return {
    id: generateId('accred'),
    accreditationNumber: `ACC-${String(idCounter).padStart(4, '0')}`,
    firstName: 'Jane',
    lastName: 'Doe',
    ...
    qidExpiry: new Date(baseDate.getTime() + 365 * 24 * 60 * 60 * 1000), // +1 year
    passportNumber: null,
    ...
    bumpInStart: new Date(baseDate.getTime() + 1 * 24 * 60 * 60 * 1000),
    bumpInEnd: new Date(baseDate.getTime() + 3 * 24 * 60 * 60 * 1000),
    hasLiveAccess: true,
    liveStart: new Date(baseDate.getTime() + 4 * 24 * 60 * 60 * 1000),
    liveEnd: new Date(baseDate.getTime() + 7 * 24 * 60 * 60 * 1000),
