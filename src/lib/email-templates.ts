// Email Templates for Be Creative Portal
// Brand color: #73c5d1
...
export function supplierApprovalEmail(data: SupplierApprovalData): { subject: string; html: string; text: string } {
  ...
  const html = emailWrapper(`
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      We are pleased to inform you that your supplier registration with Be Creative has been approved. You are now an approved vendor in our system.
    </p>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      Thank you for partnering with Be Creative. We look forward to working with you.
    </p>

    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0;">
      Best regards,<br>
      <strong>Be Creative Procurement Team</strong>
    </p>
  `);
...
We are pleased to inform you that your supplier registration with Be Creative has been approved.
...
export function assetAssignmentEmail(data: AssetAssignmentData): { subject: string; html: string; text: string } {
  ...
  const html = emailWrapper(`
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      You can view all your assigned assets by logging into the Be Creative Portal and navigating to "My Assets".
    </p>

    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0;">
      Best regards,<br>
      <strong>Be Creative IT Team</strong>
    </p>
  `);
...
You can view all your assigned assets in the Be Creative Portal under "My Assets".
...
export function changeRequestEmail(data: ChangeRequestData): { subject: string; html: string; text: string } {
  ...
  const html = emailWrapper(`
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      Please log in to the Be Creative Portal to review and approve or reject this request.
    </p>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0;">
      Best regards,<br>
      <strong>Be Creative Portal</strong>
    </p>
  `);
...
export function welcomeUserEmail(data: WelcomeUserData): { subject: string; html: string; text: string } {
  const subject = `Welcome to Be Creative Portal - ${data.userName}`;

  // Format role for display
  const roleDisplay = data.userRole.replace(/_/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase());

  const html = emailWrapper(`
    <h2 style="color: #333333; margin: 0 0 20px 0; font-size: 20px;">Welcome to Be Creative!</h2>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      Your account has been created on the Be Creative Portal. You can now access the system using your company email address.
    </p>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0;">
      Welcome aboard!<br>
      <strong>Be Creative Team</strong>
    </p>
  `);
...
Your account has been created on the Be Creative Portal.
...
export function documentExpiryAlertEmail(data: DocumentExpiryAlertData): { subject: string; html: string; text: string } {
  ...
  const html = emailWrapper(`
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0;">
      Best regards,<br>
      <strong>Be Creative HR Team</strong>
    </p>
  `);
...
export function newSupplierRegistrationEmail(data: NewSupplierRegistrationData): { subject: string; html: string; text: string } {
  ...
  const html = emailWrapper(`
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      A new supplier has registered on the Be Creative Portal and is pending your approval.
    </p>
...
// ============================================================================
// ACCREDITATION SUBMITTED EMAIL (To Approvers/Admins)
// ============================================================================

interface AccreditationSubmittedData {
...
export function accreditationSubmittedEmail(data: AccreditationSubmittedData): { subject: string; html: string; text: string } {
  const subject = `Accreditation Pending Approval: ${data.accreditationNumber} - ${data.personName}`;
  ...
  const html = emailWrapper(`
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px; margin: 0 0 25px 0;">
      <tr>
        <td style="padding: 15px 20px;">
          <p style="color: #856404; font-size: 14px; margin: 0; font-weight: bold;">
            Action Required: Accreditation Pending Approval
          </p>
        </td>
      </tr>
    </table>

    <h2 style="color: #333333; margin: 0 0 20px 0; font-size: 20px;">Accreditation Submitted for Approval</h2>

    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      An accreditation has been submitted and requires your review and approval.
    </p>

    <!-- Accreditation Details Box -->
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f8f9fa; border-radius: 8px; margin: 25px 0;">
      <tr>
        <td style="padding: 25px;">
          <h3 style="color: ${BRAND_COLOR}; margin: 0 0 15px 0; font-size: 16px;">Accreditation Details</h3>
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px; width: 40%;">Accreditation #:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px; font-weight: bold;">${data.accreditationNumber}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px;">Person Name:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px;">${data.personName}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px;">Organization:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px;">${data.organization || 'N/A'}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px;">Project:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px;">${data.projectName}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px;">Submitted By:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px;">${data.submittedBy}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666666; font-size: 14px;">Submission Date:</td>
              <td style="padding: 8px 0; color: #333333; font-size: 14px;">${formatDate(data.submissionDate)}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <p style="color: #555555; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
      Please review the accreditation details and approve or reject as appropriate.
    </p>
...
An accreditation has been submitted and requires your review.

Accreditation Details:
- Accreditation #: ${data.accreditationNumber}
