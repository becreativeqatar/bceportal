  ...
  try {
    ...
    if (q) {
      ...
      where.OR = [
        ...
        { AND: [{ serial: { not: null } }, { serial: { contains: q, mode: 'insensitive' } }] },
        { type: { contains: q, mode: 'insensitive' } },
        { AND: [{ supplier: { not: null } }, { supplier: { contains: q, mode: 'insensitive' } }] },
        { AND: [{ configuration: { not: null } }, { configuration: { contains: q, mode: 'insensitive' } }] },
      ];
  ...
  try {
    ...
    if (data.price && !priceQAR) {
      ...
      if (currency === 'QAR') {
        ...
        // USD - convert to QAR
        priceQAR = data.price * USD_TO_QAR;
      }
    }
