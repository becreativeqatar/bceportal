          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Supplier Code: <span className="font-semibold">{supplier.suppCode || <span className="italic text-gray-400">Will be assigned on approval</span>}</span>
              </p>
            </div>
            <SupplierActions
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1 p-2 bg-red-50 border border-red-200 rounded">
